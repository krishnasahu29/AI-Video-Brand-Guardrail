...
logger = logging.getLogger("multi-agentic-stack-runner")  # Creates a named logger for this module
...
def run_cli_simulation():
    ...
    try:
        ...
        status = final_state.get('final_status') or final_state.get('status')
        if status is None:
